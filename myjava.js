...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const dataSecond = [
        ...
        { characteristic: "Simple Words", comments: "The use of simplfied words is okay on this website. The use of 'fabricated' could be seen as an overly complicated word, although, this particular webpage is aimed towards the adults of children, so therefore could be considered appropriate for the audience they are aiming for. There is noting else that stands out to me, the language is rather simple and easy to read."},
    ];
